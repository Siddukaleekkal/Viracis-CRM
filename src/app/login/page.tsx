      ...
      <div className="relative z-10 w-full max-w-[440px] p-6 sm:p-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-gray-200/60 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.1)] rounded-2xl p-8 sm:p-10">
          ...
          <form action={login} className="space-y-5" autoComplete="off">
            ...
            <button
              type="submit"
              className="w-full py-2.5 px-4 bg-gray-900 text-white text-[14px] font-medium rounded-lg shadow-sm hover:bg-gray-800 focus:ring-2 focus:ring-gray-900/20 focus:outline-none transition-all mt-2 cursor-pointer"
            >
              Sign in
            </button>
          </form>
